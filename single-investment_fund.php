...
<?php
	...
	if(!isset($_COOKIE['fg_invesment_accepted'])){
...
<?php if(isset($_COOKIE['fg_invesment_accepted'])): ?>
		...
		?>
			...
			<script type="text/javascript">
				...
				jQuery(function($){
					...
					if(!isCookie('fg_invesment_accepted')){
					...
					$(document).on('click', '[data-dismiss="modal"]', function(){
						...
						setCookie('fg_invesment_accepted', '<?php echo $post->ID; ?>', 1);
